...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_score, max_num = 0.0, 1
    for num in range(10):
        score = make_averaged(roll_dice, total_samples)
        pre_score = score(num+1, dice)
        if  pre_score > max_score:
            max_score, max_num = pre_score, num + 1
    return max_num
    # END PROBLEM 9
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    tail_point = square_update(0, score, opponent_score)
    if tail_point - score >= threshold:
        return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    if score < 70:
        threshold, num_rolls = 12, 6
    else:
        threshold, num_rolls = 6, 3
    return square_strategy(score, opponent_score, threshold, num_rolls)
    # END PROBLEM 12
