...
def count_coins(change):
    ...
    def part(change, largest):
        ...
        if change < 0:
            return 0
        return part(change, next_smaller_coin(largest)) + part(change - largest, largest)
    return part(change, 25)
