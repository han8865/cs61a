...
def balanced(m):
    ...
    weight_l, weight_r = total_weight(end(left(m))), total_weight(end(right(m)))
    return len_l*weight_l == len_r*weight_r and balanced(end(left(m))) and balanced(end(right(m)))
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    "*** YOUR CODE HERE ***"
    if is_leaf(t):
        value = (label(t) if label(t) != 'loki' else lokis_replacement)
        return tree(value)
